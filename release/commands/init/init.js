...
function init(appName_1) {
    return tslib.__awaiter(this, arguments, void 0, function* (appName, { template, force = false } = {}) {
        ...
        yield logger.logger.start('Install packages', () => execAsync(`cd ${appPath} && npm i`));
    });
}
