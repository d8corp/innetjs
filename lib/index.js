                ...
                case 1:
                    ...
                    options = {
                        ...
                        plugins: [
                            ...
                            postcss__default['default']({
                                ...
                                sourceMap: true,
                                extract: process.env.CSS_EXTRACT === 'true' && path__default['default'].resolve('public/build/index.css'),
                            }),
                            typescript__default['default'](),
                            server(projectPath + "/public", cert, key),
                            livereload(__assign({ watch: 'public', verbose: false }, (key && cert ? { https: { key: key, cert: cert } } : {})))
                        ],
                    };
                    ...
                    watcher.on('event', function (e) {
                        if (e.code == 'ERROR') {
                            ...
                            eventTask = ora__default['default']('Start building\n').start();
                        }
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    indexExtension = _a.sent();
                    return [4 /*yield*/, task('Remove build', function () { return fs__default['default'].remove(projectPath + "/public/build"); })];
                case 2:
                    _a.sent();
        ...
        writeBundle: function () {
            ...
            if (!app) {
                ...
                server_1.listen(port_1, function () {
                    process.stdout.write("Server started on http" + (httpsUsing_1 ? 's' : '') + "://localhost:" + port_1 + "\n");
                });
            }
        }
    };
