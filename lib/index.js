...
function init(appName) {
    var appPath = path__default['default'].resolve(appName);
    ...
    return new listr2.Listr([
        ...
        },
        {
            ...
            task: function () {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, fs__default['default'].copy(libPath + "/template", appPath)];
                    });
                });
            }
        },
        {
            ...
            task: function () {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, exec("cd " + appPath + " && npm i")];
                    });
                });
            }
        },
